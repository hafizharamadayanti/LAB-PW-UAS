...
body {
  background-image: url('./image/hotel3.jpg');
  ...
  backdrop-filter: blur(10px);
    ...
    <title>Etheral Elegance Hotel</title>
</head>
...
<body>
    ...
    <section id="carouselExampleControls" class="carousel slide carousel_section" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="carousel-image" src="./image/bg4.jpg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/bg2.jpg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/bg1.jpg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/bg3.png">
            </div>
        </div>
    </section> -->
    ...
    <section id="auth_section">
        ...
        <div class="logo">
            <img class="logobunga" src="./image/logobunga.png" alt="logo">
            <p>Ethereal Elegance Hotel</p>
        </div>
